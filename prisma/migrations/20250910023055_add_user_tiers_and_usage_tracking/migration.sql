...
CREATE TABLE "User" (
    ...
    "dailyPdfCount" INTEGER NOT NULL DEFAULT 0,
    "dailyEmailCount" INTEGER NOT NULL DEFAULT 0,
    "lastUsageReset" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "lifetimePdfCount" INTEGER NOT NULL DEFAULT 0,
    "lifetimeEmailCount" INTEGER NOT NULL DEFAULT 0
);
